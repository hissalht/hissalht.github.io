 ...
 */
class Version20180421230658 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        , edit_date DATETIME DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_BA5AE01DF675F31B FOREIGN KEY (author_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
