 ...
 */
class Version20180515180725 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE education (id INTEGER NOT NULL, school VARCHAR(255) NOT NULL, diploma VARCHAR(255) NOT NULL, field VARCHAR(255) NOT NULL, end_year INTEGER DEFAULT NULL, description CLOB NOT NULL, start_year INTEGER NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE experience (id INTEGER NOT NULL, title VARCHAR(255) NOT NULL, company VARCHAR(255) NOT NULL, place VARCHAR(255) NOT NULL, start_date DATETIME NOT NULL --(DC2Type:datetime_immutable)
